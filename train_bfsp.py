...
class BFSPTrainer:
    ...
    def train(
        ...
        """
        # Step 1: Prepare data
        # Global statistics that previously leaked (speed-figure standard
        # times, field-size medians) are now computed with expanding windows
        # in custom_metrics.py, so a single full-dataset pass is safe.
